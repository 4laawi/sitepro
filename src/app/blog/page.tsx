  ...
  return (
    <main className="bg-white min-h-screen pt-12 pb-20">
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <section className="py-24 bg-gradient-to-br from-[#022545] to-[#04335d] text-white relative overflow-hidden rounded-[60px] mb-20">
          ...
          <div className="container px-4 mx-auto max-w-5xl text-center relative z-10">
            <div className="space-y-8">
              ...
              <h2 className="text-4xl md:text-5xl font-black text-white leading-tight">
                Prêt à lancer votre projet de <span className="text-primary-400">site web</span> au Maroc ?
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Ne restez pas invisible. Obtenez un site web ultra-performant, 100% optimisé pour le SEO et l&apos;IA pour dominer votre marché local.
              </p>
