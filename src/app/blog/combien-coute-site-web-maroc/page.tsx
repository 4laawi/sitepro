...
import { ArrowLeft, Share2, Calendar, Clock, ChevronRight, CheckCircle2, AlertCircle, HelpCircle, ArrowRight } from 'lucide-react'
                ...
                <div className="container px-4 mx-auto max-w-5xl text-center relative z-10">
                    <div className="space-y-8">
                        ...
                        <h2 className="text-4xl md:text-5xl font-black text-white leading-tight">
                            Besoin d&apos;un site web qui <span className="text-primary-400">génère des clients</span> ?
                        </h2>
                        <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                            Ne laissez pas votre business au hasard. Obtenez une plateforme digitale conçue pour la performance et le référencement au Maroc.
                        </p>
