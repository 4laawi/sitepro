...
import { ArrowLeft, Calendar, Clock, ChevronRight, CheckCircle2, Search, ShieldCheck, ArrowRight } from 'lucide-react'
                ...
                <div className="container px-4 mx-auto max-w-5xl text-center relative z-10">
                    <div className="space-y-8">
                        ...
                        <h2 className="text-4xl md:text-5xl font-black text-white leading-tight">
                            Fini l&apos;invisibilité. Dominez <span className="text-primary-400">Google Maroc</span> dès aujourd&apos;hui
                        </h2>
                        <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                            Nous créons des sites web pensés pour le SEO dès la première ligne de code. Soyez là où vos clients vous cherchent.
                        </p>
